Feature: Incluir Resolução
  ...
  Scenario Outline: Incluir resolução com erro
    ...
    Examples:
      ...
      | 12345  | 2024-01-01 | Esta é a ementa da resolução 12345             |                                                                       | Ementa não informada                                   |
      | 12345  | 2024-01-01 | Esta é a ementa da resolução 12345             |                                                                       | Link não informado                                     |
      | 12345  |                                         | Esta é a ementa da resolução 12345             | https://www.example.com/resolucoes/12345                               | Data não informada                                     |
      |                                         | 2024-01-01 | Esta é a ementa da resolução 12345             | https://www.example.com/resolucoes/12345                               | Número da resolução não informado                       |
      | 12345  | 2024-01-01 |                                               | https://www.example.com/resolucoes/12345                               | Ementa não informada                                   |
      | 12345  | 2024-01-01 | Esta é a ementa da resolução 12345             |                                                                       | Link não informado                                     |