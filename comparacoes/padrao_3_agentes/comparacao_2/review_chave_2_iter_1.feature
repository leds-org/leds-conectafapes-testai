Feature: Alterar Resolução
  ...
  Scenario Outline: Alterar resolução com erro - Atributo faltante
    ...
    Examples:
      ...
      | Res1      | nome               | O nome da resolução é obrigatório                                                                                                                               |
      | Res1      | descrição          | A descrição da resolução é obrigatória                                                                                                                            |
      | Res1      | percentual         | O percentual da resolução é obrigatório                                                                                                                           |
      | Res1      | data_início        | A data de início da resolução é obrigatória                                                                                                                         |
      | Res1      | modalidades_bolsa | As modalidades de bolsa da resolução são obrigatórias                                                                                                           |
