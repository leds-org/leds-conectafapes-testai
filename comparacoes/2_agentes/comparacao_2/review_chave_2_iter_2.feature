Feature: Alterar Resolução
  ...
  Scenario Outline: Alterar resolução com sucesso
    ...
    When o servidor altera os dados da resolução para:
      | Campo         | Valor             |
      |---------------|--------------------|
      | Sigla         | <sigla_nova>       |
      | Nome          | <nome_novo>        |
  ...
  Scenario Outline: Alterar resolução com erro - regra de negócio
    ...
    Examples:
      ...
      | Res1      | ABC       | Nome     | Descrição     | 10         | 2024-01-01  | Bolsa1             | DEF       | Novo Nome | Nova Descrição    | 20          | 2025-01-01     | Bolsa2               | A Sigla já está em uso. Utilize outra sigla                                                                                      |
