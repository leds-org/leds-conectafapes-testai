Feature: Modalidades
  ...
  Scenario: Validar se a modalidade está ativa
    Given o servidor seleciona a modalidade com sigla "ABC"
    Then o sistema deve retornar se a modalidade está ativa

  Scenario: Validar se a modalidade está em edição
    Given o servidor seleciona a modalidade com sigla "DEF"
    Then o sistema deve retornar se a modalidade está em edição
